      ...
      <form action="{{url('/')}}/registration" method="Post">
        ...
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" name="course" placeholder="Enter your password" required>
          </div>
...
.body1::before {
  ...
  width: 100%;
  height: 100%;
  background: url("{{asset('asset/images/logo.png')}}") center/cover; /* Apply the background image */
...
.container {
  position: relative;
  z-index: 1; /* Ensure the form stays above the blurred background */
